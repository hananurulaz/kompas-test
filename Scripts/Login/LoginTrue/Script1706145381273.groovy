...
WebUI.setText(findTestObject('Login/tb_Password'), 'fortesting12')

WebUI.click(findTestObject('Login/btn_MainLogin'))

WebUI.delay(5)

//verify that already on main page
WebUI.verifyElementPresent(findTestObject('Login/img_KompasHeader'), 0)
